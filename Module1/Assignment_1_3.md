...
Pre-request script :
<code>
var pubkey = "pub api key";
var pivkey = "private api key";
var ts = new Date().getTime();
var hash = CryptoJS.MD5(ts+pivkey+pubkey);
pm.collectionVariables.set("ts" , ts)
pm.collectionVariables.set("apikey", pubkey)
pm.collectionVariables.set("hash", hash.toString())
</code>

#### API call 1

Get:
https://gateway.marvel.com/v1/public/comics/82967?ts={{ts}}&apikey={{apikey}}&hash={{hash}}
        ...
        "results": [
            {
                ...
                "urls": [
                    {
                        "type": "detail",
                        "url": "http://marvel.com/comics/issue/82967/marvel_previews_2017?utm_campaign=apiRef&utm_source=1be3778a37ec9674a5ca7559bbcf2e41"
                    }
                ],
                "series": {
...
Get:
https://gateway.marvel.com/v1/public/characters/1011334?ts={{ts}}&apikey={{apikey}}&hash={{hash}}
        ...
        "results": [
            {
                ...
                "urls": [
                    {
                        "type": "detail",
                        "url": "http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=1be3778a37ec9674a5ca7559bbcf2e41"
                    },
                    {
                        "type": "wiki",
                        "url": "http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=1be3778a37ec9674a5ca7559bbcf2e41"
                    },
                    {
                        "type": "comiclink",
                        "url": "http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=1be3778a37ec9674a5ca7559bbcf2e41"
...
Get:
https://gateway.marvel.com/v1/public/creators/13970?ts={{ts}}&apikey={{apikey}}&hash={{hash}}
        ...
        "results": [
            {
                ...
                "urls": [
                    {
                        "type": "detail",
                        "url": "http://marvel.com/comics/creators/13970/o?utm_campaign=apiRef&utm_source=1be3778a37ec9674a5ca7559bbcf2e41"
                    }
                ]
            }
        ]
