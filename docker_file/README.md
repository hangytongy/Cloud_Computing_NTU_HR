...
docker logs {flask container ID} #to see logs of the web
...
#to request to IP 172.18.0.2:8080 (launched by the flask-app) every 1 second
#-c -> command 
docker run --network demo -d nicolaka/netshoot sh -c 'while true;do sleep 1; curl 172.18.0.2:8080;done'
...
# put deployment stack into a file and use 1 command to deploy
```
